...
export default function VinylDetail(props){
  ...
  return(
    <>
      <h2 class="text-4xl py-2 text-center text-gray-200">Vinyl Details</h2>
      <div class="w-1/2 bg-gray-300 text-center p-5 ml-auto mr-auto text-xl font-bold">
        <h3 class="">Band/Artist: {vinyl.band}</h3>
        <h3>Album: {vinyl.album}</h3>
        <h4>Description: {vinyl.description}</h4>
        <h4 class="text-green-700">Quantity: <strong>{vinyl.quantity}</strong></h4>
